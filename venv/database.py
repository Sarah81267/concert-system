...
class User(db.Model):
    ...
    feed_back = db.relationship('Feed_back', back_populates='user', lazy=True)  # Link Feed_back to User
...
class Concert(db.Model):
    ...
    feed_back = db.relationship('Feed_back', back_populates='concert', lazy=True)  # Link Feed_back to Concert
...
class Feed_back(db.Model):
    ...
    # Relationships
    user = db.relationship('User', back_populates='feed_back')
    concert = db.relationship('Concert', back_populates='feed_back')
